...
dataset = tf.data.TFRecordDataset('/home/chaoji/Desktop/transformer-xl/tf/data/wikitext-103/tfrecords/valid.bsz-32.tlen-96.tfrecords')
...
evaluator = TransformerXLModelEvaluator(model, adaptive_softmax, 96)
